<template>
  <div class="tester bg-white shadow-lg flex flex-col">
    <div class="flex justify-between items-center p-4">
      ...
      <router-link to="/admin" class="bg-gray-200 rounded hover:bg-gray-300 py-1 px-4">Admin Panel</router-link>
    </div>
    <hr />
    ...
    <div
      ...
      class="bg-orange-500 h-16 text-white flex justify-center items-center font-bold tests-complete"
    >
...
// import testRunner from "@/utility/testRunner";
